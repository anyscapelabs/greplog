            ...
            <>
              <div className="rounded border text-sm" style={{ backgroundColor: 'var(--bg-secondary)', borderColor: 'var(--border-primary)' }}>
                {[
                  ...
                  ['Error ID', `err_${error.id}`, 'copyable'],
              ...
              <div className="flex flex-col gap-1.5">
                <span className="text-sm font-semibold text-text-primary">Error Summary</span>
                <div className="rounded border p-3 text-sm" style={{ backgroundColor: 'var(--bg-secondary)', borderColor: 'var(--border-primary)' }}>
                  <span style={{ color: 'var(--text-primary)' }}>{error.message}</span>
                </div>
              </div>
              <div className="rounded border text-sm" style={{ backgroundColor: 'var(--bg-secondary)', borderColor: 'var(--border-primary)' }}>
                {[
